...
void aiPreInitialize(void)
{
    ...
    /* Session 08B: the FaceID embedder's compiled network (faceid.c) uses
  ...
  /* Do not call RISAF_Config() to avoid accidental compartmentalization, 
     matching the ST official example */
  // RISAF_Config();
}
