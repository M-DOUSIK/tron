...
/**
  ...
  * Do NOT define a body here — the port's implementation handles task switching.
  */
/* SVC_Handler — implemented in FreeRTOS port.c via #define vPortSVCHandler SVC_Handler */
...
/**
  ...
  * Do NOT define a body here — the port's implementation handles context switches.
  */
/* PendSV_Handler — implemented in FreeRTOS port.c via #define xPortPendSVHandler PendSV_Handler */

/**
  * @brief This function handles System tick timer.
  * Session 07: SysTick_Handler is defined in ms_osal.c.
  *   ms_osal.c's SysTick_Handler calls xPortSysTickHandler().
  *   xPortSysTickHandler() calls vApplicationTickHook() which calls HAL_IncTick().
  *   Do NOT define a body here — duplicate symbol causes linker error.
  */
/* SysTick_Handler — owned by ms_osal.c (FreeRTOS backend) */
...
/**
  ...
  *         Priority 8 — lower than DCMIPP (priority 5) so the camera
