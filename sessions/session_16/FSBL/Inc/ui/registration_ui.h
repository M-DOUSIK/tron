...
/** The name typed so far, for screens that want to address the patient by it.
 *  Never NULL; empty until the keyboard step has run. Session 16 moved name
 *  entry BEFORE the face scan precisely so the camera screen can use this. */
const char *registration_ui_name(void);
