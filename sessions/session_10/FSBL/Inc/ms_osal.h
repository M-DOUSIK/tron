 ...
 *
 * PUBLIC API — Session 07 definition, backed by FreeRTOS.
 * Session 12 will replace ms_osal.c internals with µT-Kernel 3.0 calls
 * without changing this header.
 *
 * CONTRACT:
 *   No application module (.c file) outside ms_osal.c may include
 *   FreeRTOS headers or call any FreeRTOS/CMSIS-RTOS API directly.
 *   Everything goes through the functions declared here.
 *
 ...
 * @param  priority     Task priority, 1 = lowest, (configMAX_PRIORITIES-1) = highest.
 *                      Suggested values:
