import sys, os
# Repository root. Defaults to the directory containing this script; override with
# FACE_EMBEDDING_ROOT if you run it from somewhere else.
BASE = os.environ.get("FACE_EMBEDDING_ROOT", os.path.dirname(os.path.abspath(__file__)))
os.chdir(BASE)
