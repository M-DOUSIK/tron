...
Run from the repository root:  python scratch/gen_ui_assets.py

Lives in scratch/ with the artwork it reads; ROOT is resolved from this
file's location, so it still finds sessions/ and scratch/ correctly.
"""
...
def main():
    ...
    # ---- header ----
    h = ['/* ui_assets.h - GENERATED by scratch/gen_ui_assets.py. Do not edit. */',
    ...
    # ---- source ----
    c = ['/* ui_assets_data.inc - GENERATED by scratch/gen_ui_assets.py. Do not edit.',
         ' *',
